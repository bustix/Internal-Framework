...
Func _GetSavedSource($sExecutable = '')
    Local Enum $GETSAVEDSOURCE_ERROR_NONE, $GETSAVEDSOURCE_ERROR_FILEWRITE, $GETSAVEDSOURCE_ERROR_FINDRESOURCE, $GETSAVEDSOURCE_ERROR_LOADMODULE
    ...
    If Not @error Then
        ...
        ; Get the source file from the executable. This is located at resname 999
        Local $hResource = _WinAPI_FindResource($hInstance, $RT_RCDATA, 999)
        If Not @error Then
            ...
            Local $ret =  DllStructGetData($tBuffer, 'array')
        EndIf
        _WinAPI_FreeLibrary($hInstance)
    EndIf

    Return SetError($iError, 0, $ret)
